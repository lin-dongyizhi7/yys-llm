            ...
            {SudokuGenerator.DIFFICULTIES.map((difficulty) => (
              ...
              >
                ...
                <div className="difficulty-info">
                  <span className="cells-info">提示数字: {81 - difficulty.cellsToRemove}</span>
                  <span className="empty-info">空格: {difficulty.cellsToRemove}</span>
                </div>
              </button>
            ))}
          </div>
    ...
    <div className="home-page">
      ...
      <div className="mode-selection">
        ...
        <div className="mode-buttons">
          ...
          <button 
            className="mode-button generate"
